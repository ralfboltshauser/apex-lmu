...
export const viewResources = {
  en: {
    ...
    overlays: {
      ...
      provenance: { badge: 'Generated preview · live layout', copy: 'Canvas values are examples, not player measurements. Display, supported widgets, and opacity are saved locally and applied to the race overlay immediately.' },
      toolbar: { layout: 'Layout', layoutName: 'Hypercar · Race', display: 'Target display', primary: 'Primary', noDisplays: 'No displays available', gridUnavailable: 'Grid unavailable', snapUnavailable: 'Snap unavailable', previewAria: 'Preview mode', edit: 'Edit', preview: 'Preview' },
      library: { eyebrow: 'Library', title: 'Widgets', active: '{count} active', find: 'Find a widget', findAria: 'Find a widget', unavailable: 'Unavailable: LMU does not expose a validated data source yet', communityUnavailable: 'Community widgets unavailable' },
      widgets: {
      ...
      inspector: {
        ...
        pixels: 'px', percent: '%', positionUnavailable: 'Position editing is not available yet. The live overlay uses a validated responsive layout.', behavior: 'Behavior', behaviorUnavailable: 'Automatic pit and class filters are not available yet.', hidePits: 'Hide in pits', hidePitsHint: 'Reduce clutter while stationary', classFilter: 'Auto class filter', classFilterHint: 'Prioritize your racing class', duplicateUnavailable: 'Duplicate unavailable', advancedUnavailable: 'Advanced unavailable',
      },
      guidance: { title: 'No display permission required', copy: 'Apex places a local transparent window and never captures the screen. Use LMU in borderless or windowed mode; exclusive fullscreen can cover desktop overlays.' },
      footer: { available: 'Desktop overlay available', required: 'Desktop app required', description: 'Transparent, click-through, local window', error: 'Overlay error', open: 'Show overlay', opening: 'Opening…', close: 'Close overlay', state: { closed: 'Overlay closed', opening: 'Opening overlay', ready: 'Overlay visible', error: 'Overlay failed' } },
    },
    settings: {
      units: { percent: '%' },
      ...
      connection: {
        ...
        acquisition: 'Acquisition', profile: 'Known live-data profile', sampleRate: '50 Hz', officialMemory: 'Official shared memory', officialMemoryHint: 'The bridge requests a fixed 50 Hz update loop. Unsupported or absent fields remain unknown instead of being estimated.', recording: 'Raw session recorder', alphaDisabled: 'Available in Data & storage',
      },
      overlay: { eyebrow: 'Overlay display', title: 'No capture permission needed', copy: 'Apex enumerates connected displays and places a local transparent window. It does not capture the desktop, inject into LMU, or require elevation.', fullscreen: 'Use borderless or windowed LMU. A true exclusive-fullscreen surface can cover desktop overlays.' },
      diagnostics: {
      ...
      data: {
        ...
        recorder: { eyebrow: 'Debug tooling', title: 'LMU session recorder', description: 'Start recording before LMU. Drive normally, stop, then send the single .apexrec file. Replay runs the captured raw memory through the current Apex decoder.', elapsed: 'Elapsed', snapshots: 'Raw snapshots', size: 'File size', record: 'Record session', stop: 'Stop & save', finishing: 'Finishing…', replay: 'Replay a recording', stopReplay: 'Stop replay', ready: 'Ready to record before the game starts.', failed: 'Recorder could not start.', privateTitle: 'Raw and local until you share it', privateCopy: 'The file contains exact LMU shared memory: telemetry, driver names, Steam IDs, server details and local LMU paths. It can be reviewed only with technical tools. Apex never uploads it. Maximum size is 8 GiB.', status: { idle: 'Ready', starting: 'Starting', recording: 'Recording', stopping: 'Saving', replaying: 'Replaying', complete: 'Complete', error: 'Error' } },
      },
      about: {
  ...
  de: {
    ...
    overlays: {
      ...
      provenance: { badge: 'Generierte Vorschau · Live-Layout', copy: 'Die Werte auf der Arbeitsfläche sind Beispiele, keine Spielermessungen. Bildschirm, unterstützte Widgets und Deckkraft werden lokal gespeichert und sofort auf das Renn-Overlay angewendet.' },
      toolbar: { layout: 'Layout', layoutName: 'Hypercar · Rennen', display: 'Zielbildschirm', primary: 'Primär', noDisplays: 'Keine Bildschirme verfügbar', gridUnavailable: 'Raster nicht verfügbar', snapUnavailable: 'Ausrichtung nicht verfügbar', previewAria: 'Vorschaumodus', edit: 'Bearbeiten', preview: 'Vorschau' },
      library: { eyebrow: 'Bibliothek', title: 'Widgets', active: '{count} aktiv', find: 'Widget suchen', findAria: 'Widget suchen', unavailable: 'Nicht verfügbar: LMU liefert noch keine validierte Datenquelle', communityUnavailable: 'Community-Widgets nicht verfügbar' },
      widgets: {
      ...
      inspector: {
        eyebrow: 'Inspektor', fallbackTitle: 'Widget', hideAria: 'Widget ausblenden', position: 'Position', appearance: 'Darstellung', opacity: 'Deckkraft', theme: 'Design', graphiteOnly: 'Nur Graphit', scale: 'Skalierung', scaleOnly: 'Nur 100 %', pixels: 'px', percent: '%', positionUnavailable: 'Die Positionsbearbeitung ist noch nicht verfügbar. Das Live-Overlay verwendet ein validiertes responsives Layout.', behavior: 'Verhalten', behaviorUnavailable: 'Automatische Boxen- und Klassenfilter sind noch nicht verfügbar.', hidePits: 'In der Box ausblenden', hidePitsHint: 'Im Stand weniger Ablenkung', classFilter: 'Automatischer Klassenfilter', classFilterHint: 'Priorisiert deine Rennklasse', duplicateUnavailable: 'Duplizieren nicht verfügbar', advancedUnavailable: 'Erweitert nicht verfügbar',
      },
      guidance: { title: 'Keine Bildschirmberechtigung erforderlich', copy: 'Apex platziert ein lokales transparentes Fenster und zeichnet den Bildschirm nie auf. Verwende LMU im randlosen oder Fenstermodus; exklusives Vollbild kann Desktop-Overlays überdecken.' },
      footer: { available: 'Desktop-Overlay verfügbar', required: 'Desktop-App erforderlich', description: 'Transparentes, klickdurchlässiges, lokales Fenster', error: 'Overlay-Fehler', open: 'Overlay anzeigen', opening: 'Wird geöffnet…', close: 'Overlay schließen', state: { closed: 'Overlay geschlossen', opening: 'Overlay wird geöffnet', ready: 'Overlay sichtbar', error: 'Overlay fehlgeschlagen' } },
    },
    settings: {
      units: { percent: '%' },
      ...
      connection: {
        ...
        acquisition: 'Datenerfassung', profile: 'Bekanntes Live-Datenprofil', sampleRate: '50 Hz', officialMemory: 'Offizieller Shared Memory', officialMemoryHint: 'Die Bridge fordert eine feste Aktualisierungsrate von 50 Hz an. Nicht unterstützte oder fehlende Felder bleiben unbekannt, statt geschätzt zu werden.', recording: 'Rohdaten-Session-Rekorder', alphaDisabled: 'Unter Daten & Speicher verfügbar',
      },
      overlay: { eyebrow: 'Overlay-Bildschirm', title: 'Keine Aufnahmeberechtigung erforderlich', copy: 'Apex erkennt angeschlossene Bildschirme und platziert ein lokales transparentes Fenster. Es zeichnet den Desktop nicht auf, klinkt sich nicht in LMU ein und benötigt keine Administratorrechte.', fullscreen: 'Verwende LMU im randlosen oder Fenstermodus. Echtes exklusives Vollbild kann Desktop-Overlays überdecken.' },
      diagnostics: {
      ...
      data: {
        ...
        recorder: { eyebrow: 'Debug-Werkzeug', title: 'LMU-Session-Rekorder', description: 'Starte die Aufnahme vor LMU. Fahre normal, stoppe und sende anschließend die einzelne .apexrec-Datei. Die Wiedergabe leitet die erfassten Rohdaten durch den aktuellen Apex-Decoder.', elapsed: 'Dauer', snapshots: 'Rohdaten-Snapshots', size: 'Dateigröße', record: 'Session aufnehmen', stop: 'Stoppen & speichern', finishing: 'Wird gespeichert …', replay: 'Aufzeichnung wiedergeben', stopReplay: 'Wiedergabe stoppen', ready: 'Bereit zur Aufnahme, bevor das Spiel startet.', failed: 'Rekorder konnte nicht starten.', privateTitle: 'Rohdaten bleiben lokal, bis du sie teilst', privateCopy: 'Die Datei enthält den exakten LMU Shared Memory: Telemetrie, Fahrernamen, Steam-IDs, Serverdetails und lokale LMU-Pfade. Sie ist nur mit technischen Werkzeugen prüfbar. Apex lädt sie niemals hoch. Maximale Größe: 8 GiB.', status: { idle: 'Bereit', starting: 'Startet', recording: 'Aufnahme', stopping: 'Speichert', replaying: 'Wiedergabe', complete: 'Fertig', error: 'Fehler' } },
      },
      about: {
