...
const copy = defineMessages({
  ...
  waiting: { badge: 'Waiting for Le Mans Ultimate', title: 'Start driving. Apex handles the rest.', description: 'Live values appear automatically through the local bridge. Raw debugging sessions can be recorded under Settings → Data & storage.', openLmu: 'Open LMU', anySession: 'Any session works', takeTrack: 'Take the track', connects: 'Apex connects at 50 Hz', review: 'Review', inspect: 'Inspect local recordings' },
  ...
  waiting: { badge: 'Warte auf Le Mans Ultimate', title: 'Fahr los. Apex übernimmt den Rest.', description: 'Live-Werte erscheinen automatisch über die lokale Bridge. Rohdaten für die Fehlersuche können unter Einstellungen → Daten & Speicher aufgezeichnet werden.', openLmu: 'LMU öffnen', anySession: 'Jede Sitzung funktioniert', takeTrack: 'Auf die Strecke', connects: 'Apex verbindet mit 50 Hz', review: 'Auswerten', inspect: 'Lokale Aufzeichnungen prüfen' },
