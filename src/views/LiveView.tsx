      ...
      <div className="live-layout">
        <Card className="fuel-card">
          ...
          <div className="fuel-card__stats">
            ...
            <Metric label={m.measured.virtualEnergy} value={!sessionOnly && frame.player.hybrid ? formatNumber(frame.player.hybrid.virtualEnergyPercent, language, 1) : '—'} unit={!sessionOnly && frame.player.hybrid ? m.common.percentUnit : undefined} detail={sessionOnly ? m.measured.waiting : frame.player.hybrid ? m.measured.measured : m.measured.notExposed} />
